...
<script type="text/javascript">
  ...
  window.addEvent('domready', function() {
    ...
    new PageDelete({
      ...
      page : '/IntranetAeroporto/consultar-voo.jsp', // Pagina para refresh apos deletar item
      deleteUrl : '/IntranetAeroporto/base/voo/del', // url para deletar
    ...
    new PageUpdate({
      id : 'content', // Local onde sera renderizado
      page : '/IntranetAeroporto/atualizar-voo.jsp', // Pagina para refresh apos deletar item
      deleteErrorMsg : msgDeleteError, // mensagem de erro
    });
    ...
    document.id('statusHidden').addEvent('change', function() {
      ...
      Array.each(el, function(key) {
        ...
        new Request.HTML({
          method : 'get',
          url : '/IntranetAeroporto/base/voo',
          data : json,
